...
if age > 64:
    ...
    print()
    discount=0
# Bug fixed: When age is below 64, discount gets bugged because it was in if statement. Moved it out of if statement.
...
# Bug fixed. Discount calculation was done wrong. Added brackets for PEDMAS
...
# If the user selected yes for music, and no for culture, the bot will select the trip to Vienna.
...
# If the user selected yes for beaches but no for music, the bot will select Bali.
